...
export const QUESTIONS = [
  {
    ...
    options: [
      ...
      { value: 'b2', label: '£35k – £50k' },
      { value: 'b3', label: '£50k – £70k' },
      { value: 'b4', label: '£70k – £100k' },
      { value: 'b5', label: '£100k+' },
    ],
  },
  {
    ...
    options: [
      ...
      { value: 'estate', label: 'Estate / Touring' },
      { value: 'suv', label: 'SUV' },
      { value: 'coupe', label: 'Coupé' },
      { value: 'convertible', label: 'Convertible' },
      { value: 'mpv', label: 'Family carrier' },
      { value: 'any', label: 'Surprise me', sub: 'No preference' },
    ],
  },
  {
    id: 'fuel',
    title: 'How do you feel about what’s under the bonnet?',
    options: [
      { value: 'petrol', label: 'Petrol', sub: 'Keep it classic' },
      { value: 'diesel', label: 'Diesel', sub: 'Big miles, big torque' },
      { value: 'phev', label: 'Plug-in hybrid', sub: 'Best of both' },
      { value: 'ev', label: 'Fully electric', sub: 'I’m ready' },
  ...
  },
  {
    ...
    options: [
      { value: 'city', label: 'City life', sub: 'Short hops, tight parking' },
      { value: 'commute', label: 'The daily commute' },
      { value: 'family', label: 'Family duties', sub: 'School runs, clubs, chaos' },
      { value: 'roadtrips', label: 'Long motorway trips' },
      { value: 'fun', label: 'Weekend fun', sub: 'The drive is the destination' },
    ],
  },
  {
    id: 'people',
